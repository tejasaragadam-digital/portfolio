  ...
  return (
    <section id="about" className="py-24 px-6 relative w-full bg-brand-black/0 text-white z-10">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.h2 
            className="text-4xl md:text-5xl font-bold mb-4 inline-block text-white"
          >
            <GlitchText text="The Duality of My Work" />
          </motion.h2>
          
          <div className="text-gray-400 max-w-3xl mx-auto text-lg md:text-3xl font-medium leading-relaxed min-h-[5rem] mb-10 md:mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div className="h-full">
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true, margin: "-10%" }}
              className="flex flex-col glass rounded-3xl p-6 md:p-8 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] transition-shadow duration-500 border-t border-brand-orange/20 h-full"
            >
              <div className="inline-flex items-center justify-center p-2 mb-6 self-start">
